...
:::{.fragment}
Every single pitfall here is something I have seen in my work with clients.  
And addressing it has always provided signficant improvements.
:::
...
Search result on 2025-06-01: "What is the API rate limit?" => 2,500 requests per minute
```

Data is generally not static. This creates a challenge for robust evaluation.
You may start getting very different results.
...
<br>
<br>
<div class="tenor-gif-embed" data-postid="4135521" data-share-method="host" data-aspect-ratio="1.77778" data-width="80%"><a href="https://tenor.com/view/so-fetch-mean-girls-fetch-trending-look-good-gif-4135521">So Fetch GIF</a>from <a href="https://tenor.com/search/so+fetch-gifs">So Fetch GIFs</a></div> <script type="text/javascript" async src="https://tenor.com/embed.js"></script>
:::
